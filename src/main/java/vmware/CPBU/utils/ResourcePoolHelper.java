...
public class ResourcePoolHelper {
    ...
    public static String getResourcePool(
            StubFactory stubFactory, StubConfiguration sessionStubConfig, String resourcePoolName) throws VMOperatorException {
    ...
    public static String getResourcePool(
        ...
        String datacenterName, String resourcePoolName) throws VMOperatorException {
