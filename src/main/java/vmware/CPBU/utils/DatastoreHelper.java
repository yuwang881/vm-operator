...
public class DatastoreHelper {
    ...
    public static String getDatastore(
        ...
        String datacenterName, String datastoreName) throws VMOperatorException {
        // Get the datastore
    ...
    public static String getDatastore(
            StubFactory stubFactory, StubConfiguration sessionStubConfig,
            String datastoreName) throws VMOperatorException {
    ...
    public static StorageBacking createStorageBacking(
            ...
            StubConfiguration sessionStubConfig, String dsName ) throws VMOperatorException {
