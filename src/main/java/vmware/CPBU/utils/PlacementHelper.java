...
public class PlacementHelper {
    ...
    public static VMTypes.PlacementSpec getPlacementSpecForCluster(
        ...
        String vmFolderName, String datastoreName) throws VMOperatorException {
    ...
    public static VMTypes.PlacementSpec getVMPlacementSpec(
        ...
        String clusterName, String datacenterName, String vmFolderName, String datastoreName) throws VMOperatorException {
        /*
